...
namespace TestProject1
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        [DataRow("Payal@123", "Payal@123")]
        [DataRow("pay#bano123", "pay#bano123")]
        [DataRow("pay@bano1S ", "pay@banode1S")]
        [DataRow("@payal129", "@payal129")]
        [DataRow("pay-bano123", "pay-bano123")]
        [DataRow("payal123)@1234", null)]
        [DataRow("pay@bano", null)]
        [DataRow("pay123", null)]
        [DataRow("pay@123", null)]
        [DataRow("@pa#12bano", null)]
        [DataRow(")payal12", null)]
        [DataRow(")pallu12", null)]
        [DataRow("pa-llu@12S", null)]
        [DataRow("pAaLU@s", null)]
